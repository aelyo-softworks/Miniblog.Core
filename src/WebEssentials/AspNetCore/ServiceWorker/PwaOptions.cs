...
namespace WebEssentials.AspNetCore.Pwa
{
	...
	public class PwaOptions
	{
		...
		public PwaOptions()
		{
			CacheId = PwaConstants.DefaultCacheId;
			...
			CustomServiceWorkerStrategyFileName = PwaConstants.CustomServiceworkerFileName;
			RoutesToIgnore = "";
		}
			...
			: this()
		{
			...
			CustomServiceWorkerStrategyFileName = config["pwa:customServiceWorkerFileName"] ?? CustomServiceWorkerStrategyFileName;

...
namespace Microsoft.AspNetCore.Builder
{
	...
	public static class ApplicationBuilderExtension
	{
		...
		/// </summary>
		public static IApplicationBuilder UseStaticFilesWithCache(this IApplicationBuilder app) => UseStaticFilesWithCache(app, new FileExtensionContentTypeProvider());

		/// <summary>
		/// Enables static files with custom content type provider, serving with the default cache expiration of 1 year.
		/// </summary>
		public static IApplicationBuilder UseStaticFilesWithCache(this IApplicationBuilder app, FileExtensionContentTypeProvider provider) => UseStaticFilesWithCache(app, TimeSpan.FromDays(365), provider);
		...
		public static IApplicationBuilder UseStaticFilesWithCache(this IApplicationBuilder app, TimeSpan cacheExpiration, FileExtensionContentTypeProvider provider)
		{
			...
			app.UseStaticFiles(new StaticFileOptions()
			{
				...
				{
					context.Context.Response.Headers[HeaderNames.CacheControl] = $"max-age={cacheExpiration.TotalSeconds}";

...
namespace WebEssentials.AspNetCore.OutputCaching
{
	...
	public static class OutputCacheFeatureExtensions
	{
		...
		public static void EnableOutputCaching(this HttpContext context, OutputCacheProfile profile)
		{
			...
			var varyByHeader = profile.VaryByHeader;
			var varyByParam = profile.VaryByParam;
			var varyByCustom = profile.VaryByCustom;
			var fileDependencies = profile.FileDependencies.ToArray();
			var useAbsoluteExpiration = profile.UseAbsoluteExpiration;
			var fileProvider = profile.FileProvider;
		...
		{
			var feature = context.Features.Get<OutputCacheProfile>();
		...
		internal static bool IsOutputCachingEnabled(this HttpContext context) => context.IsOutputCachingEnabled(out var _);
